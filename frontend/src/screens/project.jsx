...
function saveFileTree(ft) {
  ...
  return (
    <main className="h-screen flex bg-gray-100 flex-col md:flex-row">

<section className="left w-full md:w-[500px] bg-gray-900 rounded-lg shadow-lg flex flex-col border border-cyan-400/50">
...
<section className="right flex-grow bg-[#9DB7AD] h-full flex flex-col md:flex-row">
