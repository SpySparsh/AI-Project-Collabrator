...
var WebContainerInternal = class {
  constructor(previewScript, _instance) {
    __publicField(this, "previewScript");
    __publicField(this, "_instance");
...
var PreviewScriptAPIClient = class {
  constructor(_previewScript) {
    __publicField(this, "_previewScript");
    /**
  ...
  _on(eventType, listener) {
    ...
    if (!listenersForEvent) {
      ...
      const { listener: wrapped, subscribe } = syncSubscription((data) => {
        localListeners.forEach((listener2) => listener2(data));
      });
      listenersForEvent = {
        localListeners,
        remoteUnsubscribe: subscribe(this._previewScript.on(eventType, comlink_exports.proxy(wrapped)))
      };
    }
